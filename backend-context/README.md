...
- `GET /api/xbee/telemetry` – latest telemetry packet captured by the backend
- `GET /api/xbee/telemetry/stats` – aggregated telemetry statistics for dashboards
...
- `POST /api/xbee/mission/start` – create a new mission database (optional custom name)
- `GET /api/xbee/mission` – retrieve the active mission metadata
