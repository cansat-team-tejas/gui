...
const EMPTY_TELEMETRY: ITelemetryType = {
  TEAM_ID: "046",
  MISSION_TIME_S: 0,
  PACKET_COUNT: 0,
  ALTITUDE: 0,
...
export const getSafeTelemetryData = (
  ...
  return telemetry || EMPTY_TELEMETRY;
};
...
export const getRSSIStatus = (
  ...
  if (rssi > -50) return { color: "bg-[#00AD57]", status: "EXCELLENT" };
  if (rssi > -70) return { color: "bg-[#FFAB00]", status: "GOOD" };
