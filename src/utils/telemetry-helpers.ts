...
export const transformTelemetryToCSV = (
  ...
  return telemetryData.map((telemetry) => ({
    ...
    AQ_CO_PPM: telemetry.AQ_CO_PPM || 0,
    AQ_CH4_PPM: telemetry.AQ_CH4_PPM || 0,
    AQ_NH3_PPM: telemetry.AQ_NH3_PPM || 0,
    AQ_H2_PPM: telemetry.AQ_H2_PPM || 0,
    AQ_ETHANOL_PPM: telemetry.AQ_ETHANOL_PPM || 0,
